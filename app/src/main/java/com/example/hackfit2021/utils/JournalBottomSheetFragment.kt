...
import kotlinx.android.synthetic.main.fragment_journals_bottom_sheet.*

class JournalBottomSheetFragment : BottomSheetDialogFragment() {
    var selectedColor = "#171C26"


    companion object {
        var noteId = -1
        fun newInstance(id:Int): JournalBottomSheetFragment {
            val args = Bundle()
            val fragment = JournalBottomSheetFragment()
    ...
    override fun setupDialog(dialog: Dialog, style: Int) {
        ...
        val view = LayoutInflater.from(context).inflate(R.layout.fragment_journals_bottom_sheet,null)
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_journals_bottom_sheet,container,false)
